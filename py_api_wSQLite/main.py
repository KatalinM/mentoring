...
app.include_router(mission_router, prefix="/missions") # here we created the prefix for the mission router, so we don't have to add it to each endpoint in the mission_router.py file!
app.include_router(agent_router, prefix="/agents") # the same as above for the missions router
# http://localhost:8000/agents/1 -> get mission with id 1
